...
import com.example.pmdm02_02form.navegation.AppScreen
...
fun FirstBody(navController: NavController) {
    ...
    Column(
        ...
        TitleBox("Formulario de admisión al centro")
        ...
        SendButton(
            onClickAct = {
                val validations = Validation.validation(userName.value, userDni.value, userAge.value)
