...
fun SecondBody(navController: NavController, name: String, dni: String, age: Int) {
    Column(
        ...
        TitleBox("Bienvenido ${Text(dni)} al centro de desintoxicación")

        Spacer(modifier = Modifier.height(15.dp))

        Message("Enhorabuena ${Text(name)} por entrar a nuestro centro con solo ${Text(age.toString())} años, prometemos total desintoxicación en 3 meses")
